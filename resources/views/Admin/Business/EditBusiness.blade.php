            ...
            <div class="update clearfix">
              <div class="business-add col-md-12 col-sm-12">
                <div class="adding-new-bussines col-md-12 col-sm-12">
                  @if(!empty($business))
                  <form action="{{ route('business.update',$business->registerId) }}" method="POST" role="form" name="addproduct" enctype="multipart/form-data" id="myform" onsubmit = "return validateEditBusiness(this)">
                    @csrf
                    {{ method_field('PATCH') }}

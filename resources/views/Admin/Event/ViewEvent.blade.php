                ...
                @if(!empty($events))
                  ...
                  {{ method_field('PATCH') }}
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  > Heading (English)<span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  > Heading (Arabic)<span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                        <div style="border: 1px solid #00000026;padding: 5px;margin-bottom: 10px;background: #eee;">
                          {{ $events->headingArb }}
                        </div>
                    ...
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  > Summery(English) <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                        <div style="border: 1px solid #00000026;padding: 5px;margin-bottom: 10px;background: #eee;">
                          @php 
                    ...
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  >Summery(Arabic)  <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                        <div style="border: 1px solid #00000026;padding: 5px;margin-bottom: 10px;background: #eee;">
                          @php
                    ...
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  >Amount  <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                        <input disabled type="text" id="form-field-1" value="{{ $events->amount }}" class="companyname" name="companyname" placeholder="Name" >
                      </div>
                    </div>
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  >Phone Number  <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                        <input disabled type="text" id="form-field-1" value=" {{ $events->phone }}" class="companyname" name="companyname" placeholder="Name" >
                      </div>
                    </div>
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  >Email Id  <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                        <input disabled type="text" id="form-field-1" value=" {{ $events->email }}" class="companyname" name="companyname" placeholder="Name" >
                      </div>
                    </div>
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  >Location  <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                        <input disabled type="text" id="form-field-1" value="{{ $events->location }}" class="companyname" name="companyname" placeholder="Name" >
                      </div>
                    </div>
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  >Location Arabic <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                        <input disabled type="text" id="form-field-1" value="{{ $events->locationArb }}" class="companyname" name="companyname" placeholder="Name" >
                      </div>
                    </div>
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right"  > Event Status <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right" > Date <span style="float: right;">:</span></label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right" > Image <span style="float: right;">:</span></label>
                      <div class="col-sm-5">
                        <img id="prfl" style="border: 1px solid #00000026;width: 100%;margin-bottom: 10px;" src="{{ asset($events->image) }}" alt="your image" />
                      </div>
                    </div>
                    <!-- <div class="form-elements col-md-8 col-sm-12">
                      <label class="col-sm-3 control-label no-padding-right" > Map <span style="float: right;">:</span></label>
                      <div class="col-sm-5">

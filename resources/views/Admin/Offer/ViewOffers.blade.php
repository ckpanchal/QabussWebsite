        ...
        <div class="business-add col-md-12 col-sm-12">
              ...
              {{ method_field('PATCH') }}
                  <div class="form-elements col-md-8 col-sm-12">
                    <label class="col-sm-3 control-label no-padding-right"  > Heading (English)  </label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-elements col-md-8 col-sm-12">
                    <label class="col-sm-3 control-label no-padding-right"  > Description(English)  </label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-elements col-md-8 col-sm-12">
                    ...
                    <label class="col-sm-3 control-label no-padding-right"  >Address(English)  </label>
                    <div class="col-sm-9">
                      <div class="info-desc" style="border: 1px solid #00000026;padding: 5px;margin-bottom: 10px;background: #eee;">
                        @php
                  ...
                  <div class="form-elements col-md-8 col-sm-12">
                    ...
                    <label class="col-sm-3 control-label no-padding-right"  >Address(Arabic)  </label>
                    <div class="col-sm-9">
                      <div class="info-desc" style="border: 1px solid #00000026;padding: 5px;margin-bottom: 10px;background: #eee;">
                        @php
                  ...
                  <div class="form-elements col-md-8 col-sm-12">
                    ...
                    <label class="col-sm-3 control-label no-padding-right"  > Offer Status</label>
                    <div class="col-sm-9">
                  ...
                  <!--  <div class="col-sm-5">-->
                  <!--  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3606.9313611511743!2d51.48431281530552!3d25.30651008384538!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e45cf9f51ff3de5%3A0xc2423fd9853222b4!2sWebzone%20Technologies!5e0!3m2!1sen!2sin!4v1600846025179!5m2!1sen!2sin" width="366" height="280" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>                    </div>-->
                  <!--</div>-->
                @endif
                </form>
              </div>

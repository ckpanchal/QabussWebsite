              ...
              <table id="example" class="display" style="width:100%">
                ...
                @foreach($Offers as $Offerssingle)
                    <tr>
                      ...
                      <td  class="hidden-480">{{ $Offerssingle->created_at}}</td>

                      <td>
                      <div class="hidden-sm hidden-xs btn-group">
                    <a href="{{ route('offer.show', $Offerssingle->offerid)}}">
                    ...
                    <a href="{{ route('offer.edit', $Offerssingle->offerid)}}">
                    ...
                    <form action="{{ route('offer.destroy', $Offerssingle->offerid)}}" method="POST"  style="float: right;margin-left: 5px;">
                    @csrf
                      {{ method_field('DELETE')}}

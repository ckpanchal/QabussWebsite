        ...
        <li><a href="{{route('profile.offerview', Auth::user()->registerid)}}">Offer</a></li>
			...
			<div class="page-content">
              ...
              @if(!empty($offer))
							...
							<form action="{{ route('profile.offerupdate',$offer->offerid) }}" method="POST" role="form" name="addproduct" enctype="multipart/form-data" id="myform" onsubmit = "return validateEditOffer(this)">
              @csrf
              {{ method_field('PATCH') }}
                ...
                <div class="form-elements col-md-12 col-sm-12">
                  <label class="col-sm-2 control-label no-padding-right"> Date(Star To End)  </label>
                  <div class="col-sm-9">
                ...
                <div class="form-elements col-md-12 col-sm-12" style="margin-top: 15px;">
                  <label class="col-sm-2 control-label no-padding-right" style="margin-top : 5px;"> Select Company  </label>
                  <div class="col-sm-9" >
                ...
                <div class="form-elements col-md-12 col-sm-12" style="margin-top: 15px;">
                    <label class="col-sm-2 control-label no-padding-right" style="margin-top : 5px;"> Select Category  </label>
                    <div class="col-sm-9" >
                ...
                <div class="form-elements col-md-12 col-sm-12" style="margin-top: 10px;">
                    <label class="col-sm-2 control-label no-padding-right"  >  Location  </label>
                    <div class="col-sm-9">
                ...
                <div class="form-elements col-md-12 col-sm-12" style="margin-top: 10px;">
                    <label class="col-sm-2 control-label no-padding-right"  >  Location(Arabic)  </label>
                    <div class="col-sm-9">
                        <div class="form-elements col-sm-12 no-padding ">
                ...
                <div class="form-elements col-md-12 col-sm-12" style="margin-top: 10px;">
                    <label class="col-sm-2 control-label no-padding-right"  >  Map Location  </label>
                    <div class="col-sm-9">
                        <div class="form-elements col-sm-12 no-padding ">
                ...
                <div class="form-elements col-md-12 col-sm-12" style="margin-top: 15px;">
                    <label class="col-sm-2 control-label no-padding-right" style="margin-top : 5px;"> Select Tags  </label>
                    <div class="col-sm-9">
                ...
                <div class="form-elements col-md-12 col-sm-12" style="margin-top: 10px;">
                    <label class="col-sm-2 control-label no-padding-right"  >  External URL  </label>
                    <div class="col-sm-9">
                        <div class="form-elements col-sm-12 no-padding ">

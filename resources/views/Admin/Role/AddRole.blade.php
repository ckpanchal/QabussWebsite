          ...
          <div class="update clearfix">
            <div class="business-add col-md-8 col-sm-12">
                  ...
                  <div class="adding-new-bussines col-md-12 col-sm-12">
                    <form action="{{ route('role.store') }}" method="POST" role="form" name="addproduct" enctype="multipart/form-data" id="myform" onsubmit = "return validateUser(this)">
                    @csrf
                    <div class="form-elements col-md-8 col-sm-12">
                        <label class="col-sm-3 control-label no-padding-right"  >  Role  </label>
                        <div class="col-sm-9">
                          <input type="text" id="form-field-1" value="" class="textcls" name="role" placeholder="Name">
                        </div>
                      </div>
